...
<body>
    ...
    <div>
        <h3>${BBS_LIST.type[BBS_LIST.listSize - 1]}</h3>
        ...
        <table id="conten">
            <tr>
                <th><h2>${bbsItem.title}</h2></th>
            </tr>
            <tr>
                <th>작성자 ${bbsItem.writer}</th>
            </tr>
            <tr>
            ...
            <tr>
                    <td style="border:none">
                        <a href="bbs-list" class="table" style="margin-right:-4%; padding:1% 2%" >목록</a>
                        <c:if test="${sessionScope.LOGIN_ID == bbsItem.writer}">
                        	<a href="FreeEdit.jsp?SEQ_NO=${param.SEQ_NO }" class="write">수정</a>
                        	<a href="FreeDeletePro.jsp?SEQ_NO=${param.SEQ_NO }" class="write">삭제</a>
                        </c:if>
                    </td>
                </tr>
        </table>
	<div class="comment">
            ...
            <form>
                ...
                <input type="submit" value="확인" class="button" style="padding:1% 2%;margin-left:720px;" />
